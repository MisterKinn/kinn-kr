...
const sections = [
    {
        ...
        description: (
            <>
                ...
                contestant, so I participated with React, related frameworks, and
                git in my head for two weeks.
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        description: (
            <>
                ...
                you don't turn it off,&quot; which was quickly decided in an hour
                and went into development immediately.
                <br />
    ...
    },
    {
        ...
        description: (
            <>
                When there was nothing more peripheral I could do with my skills,
                I studied Next.JS from scratch to build up my development skills
                from midnight to 1 p.m., the deadline for submission.
                <br />
                <br />
                Previously, I only knew about the Create React App, which is now
                out of support at React, so I conducted the learning according to
                the updated version of Next.JS 14, which wasn't easy at first,
                but after studying for a long time by asking people questions, I
                became somewhat embodied and experienced the effectiveness of
                learning by doing activities such as refactoring the entire
                portfolio web page into Next.JS.
            </>
        ),
    },
    {
